for cluster in $(seq 2 15for cluster in $(seq 2 15)
  do
    python ../main.py --data_path '../../data' --dataset_name 'news20' \
        ...
        --classifier_type 'DEC_bert' --temperature 1000 --perturbation 0.001 --sentence_embedding 's_bert'
  done)
  do
    python ../main.py --data_path '../../data' --dataset_name 'news20' \
        --n_hidden_features 10 \
...
for cluster in $(seq 2 15)
  do
    python ../main.py --data_path '../../data' --dataset_name 'news20' \
        --n_hidden_features 10 \
        --cluster_type 'DEC_bert' --cluster_num $cluster --normal_class_index_list  5 6 7 8\
        --cluster_model_pretrain_epochs 400 --classifier_epochs 1\
        --classifier_type 'DEC_bert' --temperature 1000 --perturbation 0.001 --sentence_embedding 's_bert'
  done
...
for cluster in $(seq 2 15)
  do
    python ../main.py --data_path '../../data' --dataset_name 'news20' \
        --n_hidden_features 10 \
        --cluster_type 'DEC_bert' --cluster_num $cluster --normal_class_index_list  9 10 11 12\
        --cluster_model_pretrain_epochs 400 --classifier_epochs 1\
        --classifier_type 'DEC_bert' --temperature 1000 --perturbation 0.001 --sentence_embedding 's_bert'
  done
