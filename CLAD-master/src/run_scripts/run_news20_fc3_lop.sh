for cluster in $(seq 2 15)
    ...
    --classifier_type 'fc3' --temperature 1000 --perturbation 0.001 --sentence_embedding 's_bert';
    done
...
for cluster in $(seq 2 15)
    do
        python ../main.py --data_path '../../data' --dataset_name 'news20' \
    --n_hidden_features 10 \
    --cluster_type 'linear_word' --cluster_num $cluster --normal_class_index_list 5 6 7 9 \
    --cluster_model_pretrain_epochs 400 --classifier_epochs 300\
    --classifier_type 'fc3' --temperature 1000 --perturbation 0.001 --sentence_embedding 's_bert';
    done
